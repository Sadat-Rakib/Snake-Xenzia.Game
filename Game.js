...
//  Based on the key press the velocity value is changed
...
// On each key click the direction can be changed 
...
const initGame = () => {
    ...
    if (snakeX === foodX && snakeY === foodY) {
        updateFoodPosition();
        snakeBody.push([foodY, foodX]); //Add the food to the snake body array
        score++;
